...
# Introduction
<br>
The dataset consists of red variants of the Portuguese "Vinho Verde" wine.  The physicochemical (inputs) and sensory (the output) variables are available for us to assess the quality metrics of the variant of wine.
<br>
